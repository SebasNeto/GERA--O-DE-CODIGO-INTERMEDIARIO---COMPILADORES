...
typedef enum {
    AST_PROGRAM, AST_LIST_DECL, AST_DECL,
    AST_DECL_VAR, AST_TYPE_INT, AST_TYPE_REAL, AST_TYPE_VOID,
    AST_FUNC_DECL, AST_LIST_COM, AST_EXPR, AST_EMPTY, 
    AST_ASSIGN, AST_COMPOUND, AST_IF, AST_IF_ELSE,
    AST_WHILE, AST_RETURN, AST_LEQ, AST_LT, AST_GT,
    AST_GEQ, AST_EQ, AST_NEQ, AST_ADD, AST_SUB,
    AST_MUL, AST_DIV, AST_LIT_INT, AST_LIT_REAL, AST_LIT_CHAR,
    AST_ID, AST_SYMBOL
